...
public class QuotationValidationHelper {
    ...
    public void validateQuotationAndCustomerOrder(IQuotation quotation, String targetStatusCode)
        ...
        quotation.setConfrere(
                (Confrere) validationHelper.validateReferential(quotation.getConfrere(), false, "Confrere"));
        ...
        for (AssoAffaireOrder assoAffaireOrder : quotation.getAssoAffaireOrders()) {
            ...
            assoAffaireOrder
                    .setAffaire((Affaire) validationHelper.validateReferential(assoAffaireOrder.getAffaire(), true,
                            "Affaire"));
    ...
    private void validateProvision(Provision provision, boolean isOpen, boolean isCustomerOrder,
        ...
        if (provision.getDebours() != null && provision.getDebours().size() > 0)
            for (Debour debour : provision.getDebours()) {
                ...
                validationHelper.validateReferential(debour.getCompetentAuthority(), true, "competentAuthority");
        ...
        if (provision.getBodacc() != null) {
                ...
                validationHelper.validateDate(bodaccSale.getLeaseResilisationDate(),
                        isCustomerOrder
                                && constantService.getTransfertFundsTypeBail().getId()
                                        .equals(bodacc.getTransfertFundsType().getId()),
            ...
            if (bodacc.getBodaccFusion() != null) {
                ...
                for (BodaccFusionAbsorbedCompany bodaccFusionAbsorbedCompany : bodaccFusion
                    ...
                    validationHelper.validateString(bodaccFusionAbsorbedCompany.getAbsorbedCompanySiren(),
                            isCustomerOrder, 9,
                            "AbsorbedCompanySiren");
                    validationHelper.validateSiren(bodaccFusionAbsorbedCompany.getAbsorbedCompanySiren());
                    validationHelper.validateString(bodaccFusionAbsorbedCompany.getAbsorbedCompanyAddress(),
                            isCustomerOrder, 100,
                            "AbsorbedCompanyAddress");
                    validationHelper.validateReferential(bodaccFusionAbsorbedCompany.getAbsorbedCompanyLegalForm(),
                            false,
                    ...
                    validationHelper.validateReferential(
                            bodaccFusionAbsorbedCompany.getAbsorbedCompanyRcsCompetentAuthority(),
                ...
                for (BodaccFusionMergingCompany bodaccFusionMergingCompany : bodaccFusion
                    ...
                    validationHelper.validateString(bodaccFusionMergingCompany.getMergingCompanySiren(),
                            isCustomerOrder, 9,
                            "MergingCompanySiren");
                    validationHelper.validateSiren(bodaccFusionMergingCompany.getMergingCompanySiren());
                    validationHelper.validateString(bodaccFusionMergingCompany.getMergingCompanyAddress(),
                            isCustomerOrder, 100,
                    ...
                    validationHelper.validateReferential(
                            bodaccFusionMergingCompany.getMergingCompanyRcsCompetentAuthority(),
            ...
            if (bodacc.getBodaccSplit() != null) {
                ...
                for (BodaccSplitBeneficiary bodaccSplitBeneficiary : bodaccSplit.getBodaccSplitBeneficiaries()) {
                    ...
                    validationHelper.validateString(bodaccSplitBeneficiary.getBeneficiaryCompanySiren(),
                            isCustomerOrder, 9,
                            "BeneficiaryCompanySiren");
                    validationHelper.validateSiren(bodaccSplitBeneficiary.getBeneficiaryCompanySiren());
                    validationHelper.validateString(bodaccSplitBeneficiary.getBeneficiaryCompanyAddress(),
                            isCustomerOrder, 100,
                    ...
                    validationHelper.validateReferential(
                            bodaccSplitBeneficiary.getBeneficiaryCompanyRcsCompetentAuthority(),
                ...
                for (BodaccSplitCompany bodaccSplitCompany : bodaccSplit.getBodaccSplitCompanies()) {
                    validationHelper.validateString(bodaccSplitCompany.getSplitCompanyDenomination(), isCustomerOrder,
                            60,
                    ...
                    validationHelper.validateDate(bodaccSplitCompany.getSplitCompanyRcsDeclarationDate(),
                            isCustomerOrder,
        ...
        if (provision.getFormalite() != null) {
            ...
            validationHelper.validateReferential(natureCreation.getTypeExploitation(),
                    formalite.getTypePersonne().getCode()
                            .equals(constantService.getTypePersonneExploitation().getCode()),
                    "TypeExploitation");
        }
