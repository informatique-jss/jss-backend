...
import com.jss.osiris.modules.quotation.repository.guichetUnique.QualiteDeNonSedentariteRepository;
...
public class QualiteDeNonSedentariteServiceImpl implements QualiteDeNonSedentariteService {
    ...
    @Override
    @Cacheable(value = "qualiteDeNonSedentariteList", key = "#root.methodName")
