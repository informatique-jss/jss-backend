...
public class UniteLegale {
	...
	private boolean unitePurgeeUniteLegale;
	...
	public boolean isUnitePurgeeUniteLegale() {
		return unitePurgeeUniteLegale;
	}

	public void setUnitePurgeeUniteLegale(boolean unitePurgeeUniteLegale) {
	...
	public List<PeriodesUniteLegale> getPeriodesUniteLegale() {
