...
public interface CustomerOrderRepository extends CrudRepository<CustomerOrder, Integer> {
        ...
        @Query(nativeQuery = true, value = "select "
                        ...
                        + " STRING_AGG( af.siren ,', ' order by 1) as affaireSiren,"
                        + " STRING_AGG( af.address ||' '||af.postal_code||' '||city.label ||' '||country.label ,', ' order by 1) as affaireAddress,"
                        ...
                        + " co.created_date, cf.id_commercial, r.id_commercial, t.id_commercial, t2.id_commercial, co.id, r.id, t.id,t2.id, cf.id, co.description ")
