...
public interface AnnouncementReportingRepository extends CrudRepository<Quotation, Integer> {
        ...
        @Query(nativeQuery = true, value = "" +
                        ...
                        +
                        " 	ntf.label as noticeTypeFamilyLabel,pt2.label as provisionTypeLabel, "
                        +
                        ...
                        " join provision p on " +
                        " 	p.id_announcement = a.id join provision_type pt2 on pt2.id = p.id_provision_type  " +
                        ...
                        " 	'YYYY-MM-DD'), " +
                        " 	as2.label, ntf.label, " +
                        " 	c.label ,d.code , jt.label ,a.character_number, a.id,pt2.label " +
                        "")
