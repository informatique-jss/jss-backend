...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.CodeInseePays;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.CodeInseePaysNaissance;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.CodifNorme;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.DestinationLocationGeranceMand;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.ExerciceActivite;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.MineurLienParente;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.MineurNationalite;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.MineurSexe;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.MotifRejetMsa;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.PrecisionActivite;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.QualiteDeNonSedentarite;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.QualiteNonSedentaire;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.RoleConjoint;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.StatutPourFormalite;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.StatutPourLaFormalite;
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.StatutPourLaFormaliteBlocRe;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.TypeExploitation;
...
import com.jss.osiris.modules.osiris.quotation.model.guichetUnique.referentials.TypePersonneAncienExploitant;
...
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.ActiviteReguliereService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CapaciteEngagementService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodeEEEPaysService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodeInseePaysNaissanceService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodeInseePaysService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodeNationaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodePaysService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodeRolePersonneQualifieeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.CodifNormeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.ConditionVersementTVAService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.DestinationEtablissementService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.DestinationLocationGeranceMandService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.DestinationService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.DeviseCapitalService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.DiffusionINSEEService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.DocumentExtensionService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.EventsService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.ExerciceActiviteService;
...
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.FormeExerciceService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.FormeJuridiqueService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.FormeSocialeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.GenreService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.JeuneAgriculteurService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.LieuDeLiquidationService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MineurLienParenteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MineurNationaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MineurSexeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.ModalitesDeControleService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.ModeExerciceService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifCessationService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifDisparitionService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifFinEirlService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifRejetCmaService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifRejetGreffeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifRejetMsaService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.MotifTrasnfertService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.NatureCessationService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.NatureDesActiviteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.NatureDomaineService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.NatureGeranceService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.NatureVoletSocialService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.OptionEirlService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.OptionJQPAService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.OptionParticuliereRegimeBenefiService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.OrganismeAssuranceMaladieActueService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.OrigineFusionScissionService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.PerimetreService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.PeriodiciteEtOptionsParticulieService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.PeriodiciteVersementService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.PrecisionActiviteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.QualiteDeNonSedentariteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.QualiteNonSedentaireService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RegimeImpositionBenefices2Service;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RegimeImpositionBeneficesService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RegimeImpositionTVAService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RegistreEirlDeLancienneEirlService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RegistreEirlService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RoleConjointService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RoleContratService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RoleEntrepriseService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RolePourEntrepriseService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.RoleService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.SecondRoleEntrepriseService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.SituationMatrimonialeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.SituationVisAVisMsaService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutContratService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutDomaineService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutExerciceActiviteSimultanService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutFormaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutPourFormaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutPourLaFormaliteBlocReService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutPourLaFormaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutPraticienService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.StatutVisAVisFormaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.SuccursaleOuFilialeService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TaciteReconductionService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TotalitePartieService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TutelleCuratelleService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeDePersonneService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeDeStatutsService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeDissolutionService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeDocumentService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeExploitationService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeFormaliteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeLiasseService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeLocataireGerantMandataireService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeOrigineService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypePersonneAncienExploitantService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypePersonneBlocPreneurBailService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypePersonneContractanteService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypePersonneService;
import com.jss.osiris.modules.osiris.quotation.service.guichetUnique.referentials.TypeRepresentantService;
