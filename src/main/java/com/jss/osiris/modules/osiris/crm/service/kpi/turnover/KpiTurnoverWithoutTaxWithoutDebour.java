...
@Component
public class KpiTurnoverWithoutTaxWithoutDebour implements IKpiThread {
    ...
    public String getCode() {
        return "TURNOVER_WITHOUT_TAX_WITHOUT_DEBOUR";
    }
    ...
    public void computeKpiCrmValues() throws OsirisException {
        ...
        TypedQuery<WorkingTableTurnover> q2 = (TypedQuery<WorkingTableTurnover>) entityManager
                .createNativeQuery(
                        """
                                select id_responsable as idResponsable , cast (date_trunc('day' ,created_date) as date) as createdDate, sum(turnover_without_tax_without_debour) as turnover,id_commercial as idCommercial
