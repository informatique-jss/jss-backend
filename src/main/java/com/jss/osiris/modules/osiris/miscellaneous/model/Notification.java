...
public class Notification implements Serializable, IId {
  ...
  public static String PROVISION_ADD_BODACC_NOTICE = "PROVISION_ADD_BODACC_NOTICE";
  public static String PROVISION_ORDER_KBIS = "PROVISION_ORDER_KBIS";
  public static String PROVISION_ADD_BALO_NOTICE = "PROVISION_ADD_BALO_NOTICE";
  public static String PROVISION_ADD_JO_NOTICE = "PROVISION_ADD_JO_NOTICE";
  public static String SERVICE_ADD_ATTACHMENT = "SERVICE_ADD_ATTACHMENT";
  public static String SERVICE_ADD_INFORMATION = "SERVICE_ADD_INFORMATION";
  public static String ORDER_ADD_ATTACHMENT = "ORDER_ADD_ATTACHMENT";
  public static String ORDER_IMMEDIATLY_AFFECTED = "ORDER_IMMEDIATLY_AFFECTED";
  public static String ORDER_ADD_COMMENT_MYJSS = "ORDER_ADD_COMMENT_MYJSS";
  public static String QUOTATION_ADD_COMMENT_MYJSS = "QUOTATION_ADD_COMMENT_MYJSS";
  ...
  public static String INCIDENT_REPORT_ASKED = "INCIDENT_REPORT_ASKED";
  public static String MODIFIED_QUOTATION = "MODIFIED_QUOTATION";
  public static String ABANDONED_QUOTATION = "ABANDONED_QUOTATION";
  ...
  public static List<String> notificationTypes = Arrays.asList(PROVISION_ADD_ATTACHMENT, SERVICE_ADD_ATTACHMENT,
      ...
      PROVISION_GUICHET_UNIQUE_STATUS_SIGNED, SERVICE_ADD_INFORMATION,
      PERSONNAL, NEW_CANDIDACY_RECEIVED, INCIDENT_REPORT_ASKED, MODIFIED_QUOTATION, ABANDONED_QUOTATION,
      ORDER_IMMEDIATLY_AFFECTED,
      ORDER_ADD_COMMENT_MYJSS, QUOTATION_ADD_COMMENT_MYJSS, PROVISION_ADD_BODACC_NOTICE, PROVISION_ADD_BALO_NOTICE,
      PROVISION_ADD_JO_NOTICE,
      PROVISION_ORDER_KBIS);
  ...
  public static String getPROVISION_GUICHET_UNIQUE_STATUS_VALIDATED() {
    return PROVISION_GUICHET_UNIQUE_STATUS_VALIDATED;
  }
