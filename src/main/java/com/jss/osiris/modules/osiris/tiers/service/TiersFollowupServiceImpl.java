...
import com.jss.osiris.modules.osiris.tiers.repository.TiersFollowupRepository;
...
public class TiersFollowupServiceImpl implements TiersFollowupService {
    ...
    public List<TiersFollowup> addTiersFollowup(TiersFollowup tiersFollowup) throws OsirisException {
        ...
        if (tiersFollowup.getProvider() != null)
            return tiersFollowupRepository.findByProviderId(tiersFollowup.getProvider().getId());
        return null;
    }
}
