...
@Component
public class KpiFormaliteSentQuotationNumber implements IKpiThread {
    ...
    public String getCode() {
        return "FORMALITE_SENT_QUOTATION_NUMBER";
    }
        ...
        while (lastDate.isBefore(LocalDate.now())) {
            ...
            if (quotations != null) {
                ...
                for (Quotation quotation : quotations) {
                    if (quotationReportingGroupHelper.getQuotationType(quotation).equals(ReportingGroup.FORMALITIES)
                            || quotationReportingGroupHelper.getQuotationType(quotation)
                                    .equals(ReportingGroup.DEPOSIT)) {
                        if (quotation.getResponsable() != null
                                && isStatusModifiedThisDay(quotation, lastDate, QuotationStatus.SENT_TO_CUSTOMER)) {
