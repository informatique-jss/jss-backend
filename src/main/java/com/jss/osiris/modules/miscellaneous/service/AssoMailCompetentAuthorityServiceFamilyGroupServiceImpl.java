...
import com.jss.osiris.modules.miscellaneous.repository.AssoMailCompetentAuthorityServiceFamilyGroupRepository; 
...
@Service
public class AssoMailCompetentAuthorityServiceFamilyGroupServiceImpl implements AssoMailCompetentAuthorityServiceFamilyGroupService {
    ...
    public AssoMailCompetentAuthorityServiceFamilyGroup getAssoMailCompetentAuthorityServiceFamilyGroup(Integer id) {
        Optional<AssoMailCompetentAuthorityServiceFamilyGroup> assoMailCompetentAuthorityServiceFamilyGroup = assoMailCompetentAuthorityServiceFamilyGroupRepository.findById(id);
    ...
    public AssoMailCompetentAuthorityServiceFamilyGroup addOrUpdateAssoMailCompetentAuthorityServiceFamilyGroup(
        ...
        return assoMailCompetentAuthorityServiceFamilyGroupRepository.save(assoMailCompetentAuthorityServiceFamilyGroup);
    }
}
