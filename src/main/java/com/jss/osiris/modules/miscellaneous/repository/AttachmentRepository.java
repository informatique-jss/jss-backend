...
public interface AttachmentRepository extends QueryCacheCrudRepository<Attachment, Integer> {
        ...
        @Query(nativeQuery = true, value = " " +
                        ...
                        " where a.is_disabled=false and a.id_attachment_type =:attachmentTypeInvoiceId and a.id_azure_invoice is  null  and c.id_customer_order_status not in (:customerOrderStatusExcluded)  limit 10 ")
