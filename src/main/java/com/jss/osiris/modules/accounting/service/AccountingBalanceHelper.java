...
public class AccountingBalanceHelper {
    ...
    public AccountingBalanceViewTitle getBilanActif(List<AccountingBalanceBilan> accountingRecords,
        ...
        immobilisationsIncorporelles.getItems().add(getAccountingBalanceViewItemForActifBilan("Autres",
                this.brut_immobilisations_incorporelles_autres, this.provision_immobilisations_incorporelles_autres,
                accountingRecords, accountingRecordsN1, false));
        ...
        immobilisationsCorporelles.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Autres",
                        this.brut_immobilisations_corporelles_autres, this.provision_immobilisations_corporelles_autres,
                        accountingRecords, accountingRecordsN1, false));
        ...
        immobilisationsFinancieres.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Créances rattachées à des participations",
        ...
        immobilisationsFinancieres.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Autres titres immobilisés",
                        ...
                        this.provision_immobilisations_financieres_autres_titres_immobilises, accountingRecords,
                        accountingRecordsN1, false));

        bilanActifTitle.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Prêts", this.brut_immobilisations_financieres_prets,
                        this.provision_immobilisations_financieres_prets, accountingRecords, accountingRecordsN1,
                        false));

        bilanActifTitle.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Autres", this.brut_immobilisations_financieres_autres,
                        this.provision_immobilisations_financieres_autres, accountingRecords, accountingRecordsN1,
                        false));
        ...
        stocksEtEnCours.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Matières premières et autres approvisionnements ",
        ...
        stocksEtEnCours.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("En-cours de production (biens et services)",
                        this.brut_stocks_et_en_cours_en_cours_de_production,
                        this.provision_stocks_et_en_cours_en_cours_de_production, accountingRecords,
                        accountingRecordsN1,
                        true));
        ...
        stocksEtEnCours.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Produits intermédiaires et finis",
                        ...
                        this.provision_stocks_et_en_cours_produits_intermediaires_et_finis, accountingRecords,
                        accountingRecordsN1,
                        true));
        ...
        stocksEtEnCours.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Marchandises",
                        ...
                        this.provision_stocks_et_en_cours_marchandises, accountingRecords, accountingRecordsN1,
                        true));

        stocksEtEnCours.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Avances et acomptes versés sur commandes",
        ...
        creances.getItems()
                .add(getAccountingBalanceViewItemForActifBilan(
                        ...
                        this.provision_creances_creances_clients_et_comptes_rattaches, accountingRecords,
                        accountingRecordsN1,
                        true));
        ...
        valeursMobilieres.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Autres titres",
                        ...
                        this.provision_valeurs_mobilieres_de_placement_autres_titres, accountingRecords,
                        accountingRecordsN1,
                        true));

        valeursMobilieres.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Instruments de trésorerie",
                        this.brut_valeurs_mobilieres_de_placement_autres_titres, null, accountingRecords,
                        accountingRecordsN1,
                        true));

        valeursMobilieres.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Disponibilités",
                        this.brut_valeurs_mobilieres_de_placement_disponibilites, null, accountingRecords,
                        accountingRecordsN1,
                        true));

        valeursMobilieres.getItems()
                .add(getAccountingBalanceViewItemForActifBilan("Charges constatées d'avance (dont à plus d'un an)",
                        this.brut_valeurs_mobilieres_de_placement_charges_constatees_avance, null, accountingRecords,
                        accountingRecordsN1,
                        true));
        ...
        total5.setBrutN(getDebitForAccountRecordsAndAccountList(accountingRecords, this.ecarts_de_conversion_actif));
        total5.setBrutN1(getDebitForAccountRecordsAndAccountList(accountingRecordsN1, this.ecarts_de_conversion_actif));
        ...
        totalGeneral.setBrutN1(
                total.getBrutN1() + total2.getBrutN1() + total3.getBrutN1() + total4.getBrutN1() + total5.getBrutN1());
        ...
        totalGeneral.setAmortissementN1(total.getAmortissementN1() + total2.getAmortissementN1()
                + total3.getAmortissementN1() + total4.getAmortissementN1() + total5.getAmortissementN1());
        totalGeneral.setSoldeN(
                total.getSoldeN() + total2.getSoldeN() + total3.getSoldeN() + total4.getSoldeN() + total5.getSoldeN());
        totalGeneral.setSoldeN1(total.getSoldeN1() + total2.getSoldeN1() + total3.getSoldeN1() + total4.getSoldeN1()
                + total5.getSoldeN1());
    ...
    private AccountingBalanceViewItem getAccountingBalanceViewItemForActifBilan(String label, String paramBrut,
            String paramImmo,
            List<AccountingBalanceBilan> accountingRecords, List<AccountingBalanceBilan> accountingRecordsN1,
            boolean isTotal2) {
        ...
        if (paramImmo != null) {
            ...
            item.setAmortissementN1(getDebitForAccountRecordsAndAccountList(accountingRecordsN1, paramImmo));
        } else {
    ...
    public AccountingBalanceViewTitle getBilanPassif(List<AccountingBalanceBilan> accountingRecords,
        ...
        bilanPassifTitle.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Primes d'émission, de fusion, d'apport",
                        this.primes_emission_fusion_apport, null, accountingRecords, accountingRecordsN1, total1));

        bilanPassifTitle.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Ecarts de réévaluation",
                        this.ecarts_de_reevaluation, null, accountingRecords, accountingRecordsN1, total1));

        bilanPassifTitle.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Ecarts d'équivalence",
                        this.ecarts_equivalence, null, accountingRecords, accountingRecordsN1, total1));
        ...
        reserves.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Réserve légale",
                        this.reserve_legale, null, accountingRecords, accountingRecordsN1, total1));

        reserves.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Réserves statutaires ou contractuelles",
                        this.reserves_statutaires_ou_contractuelles, null, accountingRecords, accountingRecordsN1,
                        total1));

        reserves.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Réserves réglementées",
                        this.reserves_reglementees, null, accountingRecords, accountingRecordsN1, total1));
        ...
        empty1.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Report à nouveau",
                        this.report_a_nouveau, null, accountingRecords, accountingRecordsN1, total1));

        empty1.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Résultat de l'exercice (bénéfice ou perte)",
                        this.resultat_exercice, null, accountingRecords, accountingRecordsN1, total1));

        empty1.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Subventions d'investissement",
                        this.subventions_investissement, null, accountingRecords, accountingRecordsN1, total1));

        empty1.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Provisions réglementées",
                        this.provisions_reglementees, null, accountingRecords, accountingRecordsN1, total1));
        ...
        empty2.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Produit des émissions de titres participatifs",
                        this.produit_des_emissions_de_titres_participatifs, null, accountingRecords,
                        accountingRecordsN1, total1bis));

        empty2.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Avances conditionnées",
                        this.avances_conditionnees, null, accountingRecords, accountingRecordsN1, total1bis));
        ...
        empty3.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Provisions pour risques",
                        this.provisions_pour_risques, null, accountingRecords, accountingRecordsN1, total2));

        empty3.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Avances conditionnées",
                        this.provisions_pour_charges, null, accountingRecords, accountingRecordsN1, total2));
        ...
        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Emprunts obligataires convertibles",
                        this.emprunts_obligataires_convertibles, null, accountingRecords, accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Autres emprunts obligataires",
                        this.autres_emprunts_obligataires, null, accountingRecords, accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan(
                        "Emprunts et dettes auprès des établissements de crédit",
                        this.emprunts_et_dettes_aupres_des_etablissements_de_credit, null, accountingRecords,
                        accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan(
                        "Emprunts et dettes financières divers (dont emprunts participatifs)",
                        this.emprunts_et_dettes_financieres_divers, null, accountingRecords, accountingRecordsN1,
                        total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Avances et acomptes reçus sur commandes en cours",
                        this.avances_et_acomptes_recus_sur_commandes_en_cours, null, accountingRecords,
                        accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Dettes fournisseurs et comptes rattachés",
                        this.dettes_fournisseurs_et_comptes_rattaches, null, accountingRecords, accountingRecordsN1,
                        total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Dettes fiscales et sociales",
                        this.dettes_fiscales_et_sociales, null, accountingRecords, accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Dettes sur immobilisations et comptes rattachés",
                        this.dettes_sur_immobilisations_et_comptes_rattaches, null, accountingRecords,
                        accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Autres dettes",
                        this.autres_dettes, null, accountingRecords, accountingRecordsN1, total3));

        empty4.getItems()
                .add(getAccountingBalanceViewItemForPassifBilan("Produits constatés d'avance",
                        this.produits_constates_avance, null, accountingRecords, accountingRecordsN1, total3));
        ...
        totalGeneral.setBrutN1(total1.getBrutN1() + total1bis.getBrutN1() + total2.getBrutN1() + total3.getBrutN1());
    ...
    private AccountingBalanceViewItem getAccountingBalanceViewItemForPassifBilan(String label, String paramBrut,
        ...
        if (paramImmo != null) {
            ...
            item.setAmortissementN1(getCreditForAccountRecordsAndAccountList(accountingRecordsN1, paramImmo));
        } else {
            item.setAmortissementN(0f);
            item.setAmortissementN1(0f);
        }
    ...
    public List<AccountingBalanceViewTitle> getProfitAndLost(List<AccountingBalanceBilan> accountingRecords,
        ...
        profitAndLostProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Ventes de marchandises",
                        this.vente_des_marchandises_vendues, accountingRecords, accountingRecordsN1, montantNetCa));
        ...
        productionVendueTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Prestations de services",
                        this.prestations_de_services, accountingRecords, accountingRecordsN1, montantNetCa));
        ...
        productionStockee.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("En-cours de production de biens",
                        this.en_cours_de_production_de_biens, accountingRecords, accountingRecordsN1, total1));

        productionStockee.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("En-cours de production de services",
                        this.en_cours_de_production_de_services, accountingRecords, accountingRecordsN1, total1));
        ...
        productionimmobilisee.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Production immobilisée",
                        this.produtction_immobilisee, accountingRecords, accountingRecordsN1, total1));

        productionimmobilisee.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct(
                        "Produits nets partiels sur opération à long terme",
                        this.produits_net_partiels_operations_long_terme, accountingRecords, accountingRecordsN1,
                        total1));
        ...
        autresProduits.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Subventions d'exploitation",
                        this.subventions_exploitation, accountingRecords, accountingRecordsN1, total1));

        autresProduits.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Reprise sur amortissements et provisions",
                        this.reprise_sur_amort_et_prov, accountingRecords, accountingRecordsN1, total1));

        autresProduits.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Transfert de charge",
                        this.transfert_de_charges, accountingRecords, accountingRecordsN1, total1));
        ...
        profitAndLostChargesTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Achats de marchandises",
                        this.achats_de_marchandises, accountingRecords, accountingRecordsN1, total2));

        profitAndLostChargesTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Variations de stocks",
                        this.variation_de_stocks_de_marchandises, accountingRecords, accountingRecordsN1, total2));
        ...
        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Achats stockés de matières premières",
                        this.achats_stockes_matiere_premieres, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge(
                        "Achats stockés pour d'autres approvisionnements",
                        this.achats_stockes_autres_approv, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Variation de stock d'approvisionnements",
                        this.variation_de_stock_approv, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Achats de sous-traitance",
                        this.achats_de_sous_traitance, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Achats non stockés de matières et fournitures",
                        this.achats_non_stockes_de_matieres_et_fourn, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sociétés extérieures : personnel interimaire",
                        this.sce_exterieurs_personnel_interim, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sociétés extérieures : loyers crédit-bail",
                        this.sce_exterieurs_loyers_credit_bail, accountingRecords, accountingRecordsN1, total2));

        autresAchats.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sociétés extérieures : autres",
                        this.sce_exterieurs_autres, accountingRecords, accountingRecordsN1, total2));
        ...
        impots.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sur rémunérations",
                        this.impots_sur_remunerations, accountingRecords, accountingRecordsN1, total2));
        ...
        chargePersonnel.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Salaires et traitements",
                        this.salaires_et_traitements, accountingRecords, accountingRecordsN1, total2));

        chargePersonnel.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Charges sociales", this.charges_sociales,
        ...
        dotationsAmortissments.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sur immobilisations : amortissements",
                        this.sur_immo_amortissements, accountingRecords, accountingRecordsN1, total2));

        dotationsAmortissments.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sur immobilisations : provisions",
                        this.sur_immo_provisions, accountingRecords, accountingRecordsN1, total2));

        dotationsAmortissments.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sur actif circulant : provisions",
                        this.sur_actif_circulant_provisions, accountingRecords, accountingRecordsN1, total2));

        dotationsAmortissments.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Pour risques et charges : provisions",
                        this.pour_risques_et_charges_provisions, accountingRecords, accountingRecordsN1, total2));
        ...
        profitAndLostFinancialProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Produits de participations",
                        this.des_participations, accountingRecords, accountingRecordsN1, total3));

        profitAndLostFinancialProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct(
                        "Produits d'autres valeurs mobilières et créances de l'actif immobilisé",
                        this.des_vmp_et_creances, accountingRecords, accountingRecordsN1, total3));

        profitAndLostFinancialProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Autres intérêts et produits assimilés",
                        this.autres_interets_et_produits, accountingRecords, accountingRecordsN1, total3));

        profitAndLostFinancialProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct(
                        "Reprises sur provisions et transferts de charges",
                        this.reprise_sur_prov_et_transferts_charges, accountingRecords, accountingRecordsN1, total3));

        profitAndLostFinancialProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Différence positive de change",
                        this.difference_positive_de_change, accountingRecords, accountingRecordsN1, total3));

        profitAndLostFinancialProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct(
                        "Produits nets sur cessions de valeurs mobilières de placement",
                        this.produits_nets_sur_cession_vmp, accountingRecords, accountingRecordsN1, total3));
        ...
        profitAndLostFinancialChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Dotations aux amortissements et provisions",
                        this.dotations_aux_amort_et_provisions, accountingRecords, accountingRecordsN1, total4));

        profitAndLostFinancialChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Intérêts et charges assimilés",
                        this.interets_et_charges_assimiles, accountingRecords, accountingRecordsN1, total4));

        profitAndLostFinancialChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Différence négatives de change",
                        this.difference_negatives_de_change, accountingRecords, accountingRecordsN1, total4));

        profitAndLostFinancialChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge(
                        "Charges nettes sur cessions de valeurs mobilières de placement",
                        this.charges_nettes_sur_cessions_de_vmp, accountingRecords, accountingRecordsN1, total4));
        ...
        totalResultatCourantAvantImpots
                .setBrutN(total1.getBrutN() - total2.getBrutN() + total3.getBrutN() - total4.getBrutN());
        totalResultatCourantAvantImpots
                .setBrutN1(total1.getBrutN1() - total2.getBrutN1() + total3.getBrutN1() - total4.getBrutN1());
        totalResultatCourantAvantImpots
                .setSoldeN(total1.getSoldeN() - total2.getSoldeN() + total3.getSoldeN() - total4.getSoldeN());
        totalResultatCourantAvantImpots
                .setSoldeN1(total1.getSoldeN1() - total2.getSoldeN1() + total3.getSoldeN1() - total4.getSoldeN1());
        ...
        profitAndLostExceptionnalProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Sur opération de gestion",
                        this.produit_sur_operation_de_gestion, accountingRecords, accountingRecordsN1, total5));

        profitAndLostExceptionnalProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Produit de cession éléments d'actifs",
                        this.produit_de_cession_elements_actifs, accountingRecords, accountingRecordsN1, total5));

        profitAndLostExceptionnalProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Subventions d'investissement virées",
                        this.subventions_investissement_virees, accountingRecords, accountingRecordsN1, total5));

        profitAndLostExceptionnalProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Neutralisation d'amortissements",
                        this.neutralisation_amortissements, accountingRecords, accountingRecordsN1, total5));

        profitAndLostExceptionnalProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct(
                        "Reprise sur provision et transferts de charges",
                        this.reprise_sur_prov_et_transferts_charges, accountingRecords, accountingRecordsN1, total5));

        profitAndLostExceptionnalProductTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostProduct("Autres produits exceptionnels",
        ...
        profitAndLostExceptionnalChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sur opération de gestion",
                        this.charges_sur_operation_de_gestion, accountingRecords, accountingRecordsN1, total6));

        profitAndLostExceptionnalChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge(
                        "Sur opération en capital : valeur comptale des éléments cédés",
                        this.sur_operation_en_capital_valeur_comptale_des_elements_cedes, accountingRecords,
                        accountingRecordsN1, total6));

        profitAndLostExceptionnalChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge("Sur opération en capital : autres",
                        this.sur_operation_en_capital_autres, accountingRecords, accountingRecordsN1, total6));

        profitAndLostExceptionnalChargeTitle.getItems()
                .add(getAccountingBalanceViewItemForProfitAndLostCharge(
                        "Dotations aux amortissements et aux provisions",
                        this.dotations_aux_amortissements_et_aux_provisions, accountingRecords, accountingRecordsN1,
                        total6));
        ...
        totalResultatCharges.setBrutN(
                total2.getBrutN() + total4.getBrutN() + total6.getBrutN() + total7.getBrutN() + total8.getBrutN());
        totalResultatCharges.setBrutN1(
                total2.getBrutN1() + total4.getBrutN1() + total6.getBrutN1() + total7.getBrutN1() + total8.getBrutN1());
        totalResultatCharges.setSoldeN(
                total2.getSoldeN() + total4.getSoldeN() + total6.getSoldeN() + total7.getSoldeN() + total8.getSoldeN());
    ...
    private AccountingBalanceViewItem getAccountingBalanceViewItemForProfitAndLostCharge(String label, String paramBrut,
            List<AccountingBalanceBilan> accountingRecords, List<AccountingBalanceBilan> accountingRecordsN1,
            AccountingBalanceViewTitle totalItem) {
        AccountingBalanceViewItem item = new AccountingBalanceViewItem();
        item.setBrutN(
