...
public class WebSecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((auth) -> auth.requestMatchers(HttpMethod.OPTIONS).permitAll()
				...
				.requestMatchers(HttpMethod.POST, "/myjss/quotation/voucher/quotation/pricing").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/quotation/voucher/order/pricing").permitAll()
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/voucher/quotation/apply").permitAll()
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/voucher/order/apply").permitAll()
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/voucher/delete/order").permitAll()
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/voucher/delete/quotation").permitAll()
