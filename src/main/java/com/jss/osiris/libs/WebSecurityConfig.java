...
public class WebSecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((auth) -> auth.requestMatchers(HttpMethod.OPTIONS).permitAll()
				...
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/service-families/all").permitAll()
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/type-documents/service-type").permitAll()
				.requestMatchers(HttpMethod.GET, "/myjss/quotation/service-field-types/service-type").permitAll()
