...
public class WebSecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((auth) -> auth.requestMatchers(HttpMethod.OPTIONS).permitAll()
				...
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/view-list-item").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/add-to-cart").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/remove-from-cart").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/begin-checkout/quotation").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/begin-checkout/customer-order").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/add_payment_info/quotation").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/miscellaneous/ga4/add_payment_info/customer-order")
				.permitAll()
