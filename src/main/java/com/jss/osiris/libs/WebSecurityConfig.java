...
public class WebSecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((auth) -> auth.requestMatchers(HttpMethod.OPTIONS).permitAll()
				...
				.requestMatchers(HttpMethod.POST, "/myjss/crm/reading-folder").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/crm/reading-folder/delete").permitAll()
				.requestMatchers(HttpMethod.POST, "/myjss/crm/reading-folders").permitAll()
