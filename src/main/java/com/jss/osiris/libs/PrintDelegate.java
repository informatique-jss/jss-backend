  ...
  private void printZebraLabel(String addressLine1, String addressLine2, String addressLine3, String addressLine4,
    ...
    try {
      ...
      String zpl = "" +
          ...
          +
          "  " +
          " // --- NUMÉRO DE COMMANDE sous le logo --- " +
          " ^FO660,50          // juste sous les 160 dots du logo + marge " +
          " ^AZN,22,22         // police A, hauteur 30, largeur 30 " +
          " ^FD" + orderReference + "^FS   // exemple de n° de commande " +
          "  " +
