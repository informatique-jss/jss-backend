...
public class PdfTools {
    ...
    public InputStream keepPages(InputStream file, Integer fromPage, Integer toPage)
            throws OsirisException {
        PdfReader pdfReader;
        try {
            pdfReader = new PdfReader(file);
        } catch (IOException e) {
            throw new OsirisException(e, "Error while reading PDF");
        }
        pdfReader.selectPages(fromPage + "-" + toPage);
    ...
    public InputStream optimizePdf(InputStream file) throws OsirisException {
        ...
        try {
            ...
            throw new OsirisException(e, "Error while openning PDF");
        }
