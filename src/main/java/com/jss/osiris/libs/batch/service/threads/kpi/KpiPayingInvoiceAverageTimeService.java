...
public class KpiPayingInvoiceAverageTimeService implements IKpiCrm {
    ...
    public List<KpiCrmValue> computeKpiCrmValues() {
        ...
        // invoices.stream().filter(order ->
        // !order.getCreatedDate().isBefore(startOfDay) &&
        ...
        // try {
        // audits =
        // auditService.getAuditForEntityAndFieldName(Invoice.class.getSimpleName(),
        ...
        // BigDecimal.valueOf(Duration.between(sentInvoiceDate,
        // receivedPaymentDate).toMinutes()));
        // count++;
        // }
        // }
        // }
        ...
        // kpiCrmValue.setValue(kpiTotal.divide(BigDecimal.valueOf(count),
    ...
    // List.of(constantService.getInvoiceStatusSend()), responsables, startOfDay,
    // endOfDay);
    ...
    // if (count > 0) {
    // analyticStatsValue.setValue(kpiTotal.divide(BigDecimal.valueOf(count),
    // RoundingMode.HALF_UP));
