...
public class BatchServiceImpl implements BatchService, ApplicationListener<ContextClosedEvent> {
    ...
    public Batch declareNewBatch(String batchCode, Integer entityId) throws OsirisException {
        ...
        List<Batch> existingBatchs = batchRepository.findByBatchSettingsAndEntityIdAndBatchStatusIn(batchSettings.get(batchCode), 
        entityId, Arrays.asList(batchStatusService.getBatchStatusByCode(BatchStatus.NEW),batchStatusService.getBatchStatusByCode(BatchStatus.WAITING),
