...
@Service
public class CheckMailToOrderFormaliteThread implements IOsirisThread {
    @Autowired
    OrderMailIndexationDelegate orderMailIndexationDelegate;

    public String getBatchCode() {
        return Batch.CHECK_MAIL_TO_ORDER;
    }
    ...
    public void executeTask(Integer entityId)
        ...
        orderMailIndexationDelegate.checkMailsToIndexFormalites();
    }
}
