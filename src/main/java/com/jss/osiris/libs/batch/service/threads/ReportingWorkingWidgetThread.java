...
@Service
public class ReportingWorkingWidgetThread implements IOsirisThread {

        @Autowired
        ReportingWidgetService reportingWidgetService;

        public String getBatchCode() {
                return Batch.COMPUTE_REPORTING_WIDGET;
        }
        ...
        public void executeTask(Integer entityId)
                ...
                reportingWidgetService.computeReportingWidget(entityId);
        }
}
