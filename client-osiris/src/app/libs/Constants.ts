...
export const ANNOUNCEMENT_WAITING_CONFRERE_INVOICE = "ANNOUNCEMENT_WAITING_CONFRERE_INVOICE";
...
export const SIMPLE_PROVISION_WAITING_FINAL_DOCUMENT_AUTHORITY = "SIMPLE_PROVISION_WAITING_FINAL_DOCUMENT_AUTHORITY";
...
export const FORMALITE_AUTHORITY_TECHNICAL_BLOCKING = "FORMALITE_AUTHORITY_TECHNICAL_BLOCKING";
export const FORMALITE_WAITING_FINAL_DOCUMENT_AUTHORITY = "FORMALITE_WAITING_FINAL_DOCUMENT_AUTHORITY";
...
export const INCIDENT_REPORT_TO_COMPLETE = "TO_COMPLETE";
export const INCIDENT_REPORT_TO_ANALYSE = "TO_ANALYSE";
...
// INFOGREFFE Status
export const REJETE_DEF_GRF = "REJETE_DEF_GRF";
export const REJETE_GRF = "REJETE_GRF";
export const RECU_PAR_LE_GRF = "RECU_PAR_LE_GRF";
export const REPRISE = "REPRISE";
export const SAUVEGARDE = "SAUVEGARDE";
