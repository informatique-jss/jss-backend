...
export const INTEGER_SERVICE_FIELD_TYPE = "Nombre entier";
export const TEXT_SERVICE_FIELD_TYPE = "Texte";
export const DATE_SERVICE_FIELD_TYPE = "Date";
export const RADIO_SERVICE_FIELD_TYPE = "Radio";
