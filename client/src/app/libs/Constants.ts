...
export const ANNOUNCEMENT_WAITING_CONFRERE = "ANNOUNCEMENT_WAITING_CONFRERE";

// Simple provision status
export const SIMPLE_PROVISION_WAITING_DOCUMENT = "SIMPLE_PROVISION_WAITING_DOCUMENT";
export const SIMPLE_PROVISION_WAITING_DOCUMENT_AUTHORITY = "SIMPLE_PROVISION_WAITING_DOCUMENT_AUTHORITY";
