...
export const SERVICE_FIELD_TYPE_INTEGER = "Nombre entier";
export const SERVICE_FIELD_TYPE_TEXT = "Texte";
export const SERVICE_FIELD_TYPE_DATE = "Date";
export const SERVICE_FIELD_TYPE_RADIO = "Radio";
