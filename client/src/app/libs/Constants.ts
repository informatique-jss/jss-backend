...
//Infogreffe Status
export const INFOGREFFE_STATUS_SENDING_PENDING = "ENVOI_EN_COURS";
export const INFOGREFFE_STATUS_SAVE = "SAUVEGARDE";
export const INFOGREFFE_STATUS_STRICT_REJECT = "REJETE_DEF_GRF";
export const INFOGREFFE_STATUS_REJECT = "REJETE_GRF";
export const INFOGREFFE_STATUS_RECEIVED = "RECU_PAR_LE_GRF";
export const INFOGREFFE_STATUS_TAKEN = "REPRISE";
export const INFOGREFFE_STATUS_SEND = "ENVOYE_AU_GRF";
export const INFOGREFFE_STATUS_VALIDATED = "VALIDE";
