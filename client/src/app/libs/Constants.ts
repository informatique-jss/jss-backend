...
export const CUSTOMER_ORDER_STATUS_TO_VERIFY = "TO_VERIFY";
export const CUSTOMER_ORDER_STATUS_BEING_PROCESSED = "TO_VERIFY";
export const CUSTOMER_ORDER_STATUS_TO_BILLED = "TO_VERIFY";
