...
import { INVOICE_ENTITY_TYPE, PROVISION_ENTITY_TYPE, QUOTATION_ENTITY_TYPE, RESPONSABLE_ENTITY_TYPE, TIERS_ENTITY_TYPE } from 'src/app/routing/search/search.component';
