...
export class ChipsStatusComponent implements OnInit {
  ...
  okStatus: string[] = ['SELECTED', VALIDATED_BY_CUSTOMER, CUSTOMER_ORDER_STATUS_BILLED, this.constantService.getInvoiceStatusPayed().code, this.constantService.getInvoiceStatusCreditNoteEmited().code];
  ...
  koStatus: string[] = ['EMPHASIZED', QUOTATION_STATUS_REFUSED_BY_CUSTOMER, this.constantService.getInvoiceStatusCancelled().code];
