...
export class DirectDebitTransfertListComponent implements OnInit, AfterContentChecked {
  ...
  ngOnInit() {
    ...
    this.availableColumns.push({ id: "isMatched", fieldName: "isMatched", label: "Est rapproché ?", valueFonction: (element: DirectDebitTransfertSearchResult, column: SortTableColumn<DirectDebitTransfertSearchResult>) => { return (element.isMatched) ? "Oui" : "Non" } } as SortTableColumn<DirectDebitTransfertSearchResult>);
