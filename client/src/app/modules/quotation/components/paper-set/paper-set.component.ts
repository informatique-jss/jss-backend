...
export class PaperSetComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.displayedColumns.push({ id: "creationComment", fieldName: "creationComment", label: "Commentaire formaliste" } as SortTableColumn<PaperSet>);
    this.displayedColumns.push({ id: "validationComment", fieldName: "validationComment", label: "Commentaire final" } as SortTableColumn<PaperSet>);
    ...
    if (this.customerOrder) {
      ...
      dialogRef.afterClosed().subscribe(dialogResult => {
        if (dialogResult != null && this.customerOrder) {
          ...
          paperSet.creationComment = dialogResult.comment;
